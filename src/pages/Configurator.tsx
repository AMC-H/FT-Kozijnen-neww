...
const Configurator: React.FC = () => {
  ...
  switch (field) {
    ...
    case 'breedte':
      const minBreedte = (selectedModel?.type === 'ekovitre' ? EKOVITRE_MIN_BREEDTE : 400)
      const maxBreedte = (selectedModel?.type === 'ekovitre' ? EKOVITRE_MAX_BREEDTE : 3000)
      return (
        <div>
    ...
    case 'hoogte':
      const minHoogte = (selectedModel?.type === 'ekovitre' ? EKOVITRE_MIN_HOOGTE : 400)
      const maxHoogte = (selectedModel?.type === 'ekovitre' ? EKOVITRE_MAX_HOOGTE : 3000)
      return (
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-2">
            Hoogte (mm) * 
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                {/* ET Panelen/Despiro kun je evt. hier verwijderen of omzetten naar een andere collectie */}
                {/* <div ...>Despiro Deuren</div> */}
              </div>
            </div>
          </div>
        </div>
