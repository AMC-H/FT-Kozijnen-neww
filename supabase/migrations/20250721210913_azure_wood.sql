/*
  # Revert kozijn afmetingen naar mm

  1. Updates
    - Zet width terug naar 900 (mm)
    - Zet height terug naar 1200 (mm)
    - Behoud alle andere specificaties
*/
...
WHERE id = (
  ...
  WHERE name ILIKE '%kozijn%draaikiep%900%1200%' 
  OR description ILIKE '%kozijn-1x-draaikiep-vol-glas-900x1200%'
  LIMIT 1
);