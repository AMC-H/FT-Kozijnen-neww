/*
  # Update kozijn product 900x1200 met cm afmetingen

  1. Updates
    - Converteer afmetingen naar cm (900mm = 90cm, 1200mm = 120cm)
    - Update alle productgegevens volgens specificaties
    - Zet correcte prijzen en korting
    
  2. Product Details
    - Naam: "Kozijn 1x draaikiep vol glas 900×1200"
    - Afmetingen: 90×120 cm
    - Prijzen: €469,00 → €409,00 (13% korting)
*/
