/*
  ...
  1. New Product
    - `garage-deur-6x-roeden-2000x2100` (slug)
    - Name: "Garage deur 6x roeden 2000×2100"
    - Category: deuren
    ...
    - High security features and premium hardware
*/

-- Insert or update the garage door product
