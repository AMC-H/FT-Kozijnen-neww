/*
  # Create kozijn 2x draaikiep midden vast vol glas 2200x1100 product
  ...
  1. New Product
    ...
    - Description: Technical specifications with proper formatting
*/
...
INSERT INTO stock_items (
  ...
  jsonb_build_object(
    ...
    'frame_type', 'Standaard kozijn met vast middendeel'
  ),
  4.5,
  12,
  17,
